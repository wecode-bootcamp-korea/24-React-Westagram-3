          ...
          <main>
            ...
            <article>
              ...
              <div className="articleWrapper">
                ...
                <div className="article">
                  <img
                    src="https://s.hdnux.com/photos/01/20/77/62/21232818/3/rawImage.jpg"
                    alt=""
                  />
          ...
          <aside>
            <div className="asideContent">
              ...
              <div className="sideFooter">
                ...
                <a href="/index">센터</a>
                <a href="/index">API</a>
                <a href="/index">채용 정보</a>
                <a href="/index">개인정보처리방침</a>
                <a href="/index">약관위치인기</a>
                <a href="/index">계정</a>
                <a href="/index">해시태그</a>
                <a href="/index">언어</a>
                <br></br>
          ...
          <div className="search">
            ...
            <div className="searchList">
              <div className="listHeader">
                <span className="recentRecords">최근 검색 목록</span>
                <span className="delAll">모두 지우기</span>
              </div>
              <ul className="searchRecords">
                <li className="searched">
                  <div className="searchedImg">
                    <img src="" alt="" />#
                  </div>
                  <span className="id"></span>
                  <span className="idDescription"></span>
                  <span className="keyword">#넷플릭스</span>
                  <span className="listDel">X</span>
                </li>
                <li className="searched">
                  <div className="searchedImg">
                    <img src="" alt="" />#
                  ...
                  <span className="id"></span>
                  <span className="idDescription"></span>
                  <span className="keyword">#선릉역 맛집</span>
                  <span className="listDel">X</span>
                </li>
                <li className="searched">
                  <div className="searchedImg">
                  ...
                  <span className="id"></span>
                  <span className="idDescription"></span>
                  <span className="keyword">#위코드</span>
                  <span className="listDel">X</span>
                </li>
              </ul>
            </div>
